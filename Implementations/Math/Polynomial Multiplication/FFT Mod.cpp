...
namespace FFT {
    // greater than the maximum degree of the product
    const int maxf = 1 << 17;
    struct cp {
        ld x, y;
    ...
    // normal multiplication using fft
    ...
    // multiplication modulo (mod) using fft
    ...
    // calling this function is easier
    ...
    // returns {d, r}. a / b = d, a % b = r, all the coeffs are taken modulo mod
...
// Evaluates the polynomial 'poly' on n points
// val[i] = P(a[i])
void testmuleval() {
    n = 5000, m = 5000;
